...
public class MenuManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Metodo público para el botón de Ajustes y el botón de Volver.
    ...
    public void OpenUrl(string url)
    {
        ...
        {
            Debug.LogWarning("La URL proporcionada es nula o vac�a.");
        }
    }

    /// <summary>
    /// Corrutina que gestiona el cierre de sesión del usuario.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Llama a la corrutina para cerrar sesión.
    /// </summary>
    public void LogOut()
    {
